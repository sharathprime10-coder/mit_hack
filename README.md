# Team Samarth - CPRI Data Challenge
...
| `Team_Samarth.csv` | Submission file generated by the pipeline |
...
`Team_Samarth.csv` and `summary.json` to the same directory. It can also be
